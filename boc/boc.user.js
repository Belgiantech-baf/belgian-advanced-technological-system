...
(function () {
  ...
  function mount() {
    ...
    state.panel.className = 'geofs-list geofs-toggle-panel geofs-preferences geofs-stopMousePropagation geofs-stopKeyupPropagation boc-list';
